...
class GoogleSheetExportException(Exception):
    pass
...
class GoogleReparentException(Exception):
    pass

class BadAuthtypeException(Exception):
    pass

class ParserParseException(Exception):
    pass

class ParserWriteException(Exception):
    pass
