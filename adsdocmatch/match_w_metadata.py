...
class MatchMetadata():
    ...
    def match_to_arXiv(self, filename):
        ...
        try:
            ...
            return [{'source_bibcode': 'not available', 'comment' : 'Exception: %s in metadata file: %s'%(e, filename), 'status_flaw' : 'got exception, processing stopped, shall be added to the rerun list.'}]
    ...
    def match_to_pub(self, filename):
        ...
        try:
            ...
            logger.error('Exception: %s'%e)
            return [{'source_bibcode': 'not available', 'comment' : 'Exception: %s in metadata file: %s'%(e, filename), 'status_flaw' : 'exception, processing stopped, added to the rerun list'}]
